...
public  static  void  main (String [] args){
	...
	String sum = add (tal1 , tal2);
     ...
     //as character strings and returns their sum as a character string.
	...
	return result2;
     ...
     // The subtract method accepts two natural numbers represented 
     //as character strings and returns their difference  as a character  string.
     ...
     // The show method presents two natural numbers, operator and the result string
